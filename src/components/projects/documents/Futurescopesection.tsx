  ...
  return (
    <section className="mb-16">
      ...
      <div className="bg-background/50 border border-border rounded-lg p-8">
        {data.roadmap && (
          <p className="text-foreground/80 leading-relaxed mb-6">{data.roadmap}</p>
        )}
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              {phases.map(([phase, items]) => (
                <div key={phase} className="bg-primary/10 border border-border rounded-lg p-6">
                  <h4 className="font-semibold text-primary/80 mb-3">{phase}</h4>
        ...
        {general.length > 0 && (
          <div className="bg-primary/10 border border-border rounded-lg p-6">
            <h4 className="font-semibold text-primary mb-3">Additional Planned Features</h4>

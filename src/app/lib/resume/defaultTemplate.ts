import { buildResumeDocument } from "./supportedPackages";
...
/** Default template for new resumes — uses only RESUME_SUPPORTED_PACKAGES. */
...
/** Demo account seed resume — same supported package set, placeholder content. */
